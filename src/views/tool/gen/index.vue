<template>
  <div class="app-container">
    ...
    />
    <!-- 预览界面 -->
    <el-dialog draggable :title="preview.title" v-model="preview.open" width="80%" top="5vh" append-to-body class="scrollbar">
...
function handleGenTable(row) {
  ...
  if (row.genType === "1") {
    ...
    proxy.$download.zip("/tool/gen/batchGenCode?tables=" + tbNames, "bluett.zip");
  }
}
/** 同步数据库操作 */
